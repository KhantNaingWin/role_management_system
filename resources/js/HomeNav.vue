        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <template v-else>
              ...
              <a href="/login" class="text-sm text-gray-700 dark:text-gray-200 hover:underline">Login</a>
              <a href="/register" class="text-sm text-gray-700 dark:text-gray-200 hover:underline">Register</a>
            </template>
          </div>
